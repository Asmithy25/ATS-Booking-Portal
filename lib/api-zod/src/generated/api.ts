...
export const ListBookingsResponseItem = zod.object({
  ...
  "status": zod.enum(['pending', 'claimed', 'completed', 'cancelled']),
  ...
  "previousSessionCount": zod.number().optional().describe('Number of prior sessions for this phone number'),
...
export const UpdateBookingBody = zod.object({
  "status": zod.enum(['pending', 'claimed', 'completed', 'cancelled']).optional(),
