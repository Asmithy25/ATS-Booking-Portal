 ...
 * @summary Staff login
 */
export const staffLogin = async (loginInput: LoginInput, options?: Parameters<typeof customFetch>[1]): Promise<LoginResult> => {
 ...
 */
export const staffLogout = async ( options?: Parameters<typeof customFetch>[1]): Promise<MessageResponse> => {
 ...
 */
export const getAuthMe = async ( options?: Parameters<typeof customFetch>[1]): Promise<SessionInfo> => {
 ...
 */
export const deleteBooking = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<MessageResponse> => {
 ...
 */
export const getMyHours = async ( options?: Parameters<typeof customFetch>[1]): Promise<TherapistHours> => {
 ...
 */
export const updateMyHours = async (therapistHoursUpdate: TherapistHoursUpdate, options?: Parameters<typeof customFetch>[1]): Promise<TherapistHours> => {
 ...
 */
export const listEmployees = async ( options?: Parameters<typeof customFetch>[1]): Promise<StaffAccount[]> => {
 ...
 */
export const createEmployee = async (staffAccountInput: StaffAccountInput, options?: Parameters<typeof customFetch>[1]): Promise<StaffAccount> => {
...
export const updateEmployee = async (id: number,
    staffAccountUpdate: StaffAccountUpdate, options?: Parameters<typeof customFetch>[1]): Promise<StaffAccount> => {
 ...
 */
export const deleteEmployee = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<MessageResponse> => {
...
export const resetEmployeePassword = async (id: number,
    resetPasswordInput: ResetPasswordInput, options?: Parameters<typeof customFetch>[1]): Promise<MessageResponse> => {
 ...
 */
export const getClientHistory = async (phone: string, options?: Parameters<typeof customFetch>[1]): Promise<ClientHistory> => {
