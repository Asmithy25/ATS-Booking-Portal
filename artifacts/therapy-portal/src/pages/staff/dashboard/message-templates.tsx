...
export default function MessageTemplates() {
  ...
  return <div className="space-y-7">
     <div><p className="text-sm text-muted-foreground">Client communication</p><h1 className="text-3xl font-semibold">Message templates</h1><p className="mt-2 text-muted-foreground">Customize reusable replies for confirmations, reminders, starting-soon notices, cancellations, and business updates. They are available in the Support inbox and remain editable before sending.</p></div>
