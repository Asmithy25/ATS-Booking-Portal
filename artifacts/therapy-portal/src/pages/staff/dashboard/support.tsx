...
import { Check, CheckCheck, Copy, MessageCircle, Send, RotateCcw, WandSparkles } from 'lucide-react';
...
export default function Support() {
  ...
  const copyReply = async (threadId: number) => {
